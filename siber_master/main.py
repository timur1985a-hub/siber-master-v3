...
# --- SİBER ARŞİV BAŞLATMA VE HATA KORUMASI ---
...
.archive-alert{background:rgba(241,224,90,0.1);border:1px solid #f1e05a;color:#f1e05a;padding:10px;border-radius:8px;margin-bottom:15px;font-size:0.9rem;border-left:5px solid #f1e05a}
</style>
"""
