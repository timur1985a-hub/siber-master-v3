...
if "last_update" not in st.session_state: st.session_state["last_update"] = "Henüz Veri Alınmadı"
...
st.markdown("""
    ...
    .wa-small { display: block; width: 100%; max-width: 300px; margin: 0 auto 15
