...
def get_final_vault():
    vault = {}
    # Kampanya Paketleri: 1-AY, 3-AY, 6-AY, 12-AY, SINIRSIZ
    config = [
        ("1-AYLIK", 30, 100), 
        ("3-AYLIK", 90, 100), 
        ("6-AYLIK", 180, 100), 
...
# ================= 2. TAM EKRAN VE SABİT ARAYÜZ TASARIMI =================
...
st.markdown(f"""
    ...
    /* SABİT VE YAN YANA PAKETLER (KAYMAZ) */
    .pkg-row {{ 
        display: flex; gap: 5px; justify-content: center; 
        margin-bottom: 15px; flex-wrap: wrap; /* Ekrana sığmazsa alt satıra geçer ama kaymaz */
    }}
    .pkg-box {{ 
    ...
    /* KÜÇÜK VE ZARİF WHATSAPP BUTONU */
    .wa-small {{
        ...
        box-shadow: 0 4px 15px rgba(35, 134, 54, 0.2); transition: 0.3s;
    }}
    .wa-small:hover {{ background: #2ea043; transform: scale(1.02); }}
...
if not st.session_state["auth"]:
    ...
    try:
            ...
            if conf >= trust:
                ...
                <div class='card'>
                    ...
                    <div style='background:rgba(0,0,0,0.3); padding:15px; border-radius:10px;'>
                        ...
                        <small>📍 {f['teams']['home']['name'] if h_eff > a_eff else f['teams']['away']['name']} tarafı sahayı domine ediyor.</small><br>
                        <small>🔥 {max(h_shots, a_shots)} şut ve {xg} gol beklentisi ile analiz ispatlanmıştır.</small>
        ...
        st.warning("Siber hatlar yoğun, veri bekleniyor...")
