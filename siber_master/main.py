...
def get_hardcoded_vault():
    """PAKET BAZLI 2000 LİSANS İSKELETİ"""
    v = {}
...
# --- 3. HİBRİT ANALİZ MOTORU (DOKUNULMAZ) ---
...
if not st.session_state["auth"]:
        ...
        for i, tab in enumerate(tabs):
            ...
            with tab:
                ...
                for t, info in pkg_lics.items():
                    ...
                    with col_a:
                        exp_txt = f"⌛ KALAN: {(info['exp'] - now).days} GÜN" if info["issued"] else "⚪ BEKLEMEDE (Süre Başlamadı)"
    ...
    # --- ANALİZ VE LİSTE GÖSTERİMİ (DOKUNULMAZ YAPI) ---
