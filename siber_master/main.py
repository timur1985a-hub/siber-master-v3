...
# --- OTOMATİK TANIMA SİSTEMİ (RECALL) ---
...
def check_success(emir, gh, ga):
    ...
    if "İLK YARI 0.5 ÜST" in emir: return total > 0 # Basit kontrol, geliştirilebilir
...
def advanced_decision_engine(m):
    ...
    if elapsed > 0:
        ...
        elif elapsed >= 40 and elapsed < 75 and total < 2: live_emir = "1.5 ÜST"
...
if not st.session_state["auth"]:
    ...
    st.markdown("<div class='marketing-subtitle'>Gelişmiş Yapay Zeka Karar Mekanizması</div>", unsafe_allow_html=True)
    ...
    # --- GERİ GETİRİLEN VE GÜÇLENDİRİLEN BAŞARI PANELİ ---
        ...
        st.markdown(f"""
            <div class='decision-card' style='border-left: 6px solid {color};'>
                ...
                <div style='display:flex; gap:10px; margin-top:10px;'>
                    ...
                    <div style='flex:1; padding:8px; background:rgba(46,160,67,0.05); border:1px solid #30363d; border-radius:6px;'>
