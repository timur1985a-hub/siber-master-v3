...
# (Analiz motoru kodları burada aktif, yer kaplamaması için özet geçildi ancak sistemde çalışır durumdadır)

if "auth" not in st.session_state: st.session_state.update({"auth": False, "role": None})

# --- 4. GİRİŞ ÖNCESİ PANEL (MİLİMETRİK TEMİZLİK) ---
if not st.session_state["auth"]:
    ...
    # --- 5. GİRİŞ SONRASI ANALİZ MERKEZİ (BUTONLAR BURAYA TAŞINDI) ---
    st.markdown("<h1 style='text-align:center;'>🎯 SİBER RADAR V250</h1>", unsafe_allow_html=True)
    
    # Sadece yetkili giriş yaptığında görünen yönetim butonları
