...
# --- 1. ÇEKİRDEK AYARLAR VE LİSANS SİSTEMİ ---
...
def get_auth_vault():
    ...
    for label, days in config:
        for i in range(1, 101):
            seed = f"V28_{label}_{i}_2026_TIMUR"
...
# --- 2. TASARIM KORUMA (MİLİM DEĞİŞİKLİK YOK) ---
...
# --- 3. SİBER ANALİZ MOTORU (SGE MANTIĞI) ---
...
# --- 4. GİRİŞ PANELİ (SIRA SENDE! - SABİT ŞABLON) ---
if not st.session_state["auth"]:
    ...
    with c2:
        ...
        with t_user:
            u_key = st.text_input("Anahtar:", type="password", key="u_key_main")
        ...
        with t_admin:
            a_t = st.text_input("Master Token:", type="password", key="a_t_main")
            a_p = st.text_input("Şifre:", type="password", key="a_p_main")
    ...
    # --- 5. İSPAT KANALLARI (CANLI ANALİZ PANELİ) ---
    ...
    with st.sidebar:
        ...
        if st.session_state["role"] == "admin":
            ...
            st.text_area("Kodlar:", value="\n".join([k for k,v in VAULT.items() if v["label"]==sel]), height=250)
            ...
            if conf >= trust:
                ...
                <div class='card'>
                    ...
                    <div style='background:rgba(0,0,0,0.3); padding:15px; border-radius:10px;'>
                        ...
                        <small>📍 {h_n if h_sge > a_sge else a_n} tarafı SGE endeksine göre sahayı domine ediyor.</small>
