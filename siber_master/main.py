...
if "auth" not in st.session_state:
    st.session_state.update({
        ...
        "siber_archive": {} # Yeni Arşiv Belleği
    })

# Bellek Koruma Sistemi
...
.marquee-container{background:rgba(13,17,23,0.9);border-top:2px solid #f85149;border-bottom:2px solid #f85149;box-shadow:0 0 15px rgba
