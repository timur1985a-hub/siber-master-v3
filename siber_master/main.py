...
# --- CANLI DESTEK SİSTEMİ (GÖRÜNMEZ KATMAN) ---
def inject_tawk():
    tawk_script = """
...
if not st.session_state["auth"]:
    ...
    if st.session_state["role"] == "admin":
        ...
        st.success(f"📊 ŞU AN AKTİF TRAFİK: {st.session_state['total_hits']} ZİYARETÇİ")
    else:
