...
def fetch_data():
    try:
        # Önbelleği (cache) aşmak için doğrudan requests
...
if not st.session_state["auth"]:
    ...
    # Giriş ekranı marquee için veri
    ...
    if st.session_state["stored_matches"]:
        ...
        for i, m in enumerate(filtered):
            ...
            msg = f"🔥 CANLI: {m['goals']['home']}-{m['goals']['away']} | {'SIRADAKİ GOL' if rcs_val > 70 else 'GOL RİSKLİ'}" if is_live else "🚀 ANALİZ: Taktiksel Verimlilik Teyit Edildi. Karar: 1.5 ÜST / MS 1X"
